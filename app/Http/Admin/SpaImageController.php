...
class SpaImageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('spa.show', [$request->spa_id])->with('message', 'Image added Successfully');
    }
    ...
    public function destroy($id)
    {
        $p = SpaImage::find($id);
        $p->delete();
        return redirect()->route('spa.show', [$p->spa_id])->with('message', 'Image deleted Successfully');
    }
}
