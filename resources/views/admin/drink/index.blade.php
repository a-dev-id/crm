...
@section('nav_button')
    <li class="nav-item">
        <a class="nav-link btn btn-success btn-sm text-white font-weight-bold" href="{{ route('drink.create') }}">
                                    ...
                                    @foreach ($drinks as $d)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('drink.edit', [$d->id]) }}" class="btn btn-sm btn-warning">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal_delete_{{ $d->id }}">
                                                    <i class="fas fa-trash"></i>
                                                </button>

                                                <div class="modal fade" id="modal_delete_{{ $d->id }}">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-left">
                                                                Are you sure want to delete this <strong>"{{ $d->title }}"</strong> ?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-ban"></i> Cancel</button>
                                                                <form method="POST" action="{{ route('drink.destroy', [$d->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
