...
<x-app-layout>
    <section class="content">
        <div class="container-fluid">
            <form method="POST" action="{{ route('page.store') }}" enctype="multipart/form-data" class="row">
                @csrf
                <div class="col-lg-8">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="term_condition" class="form-control" rows="4" id="term_condition" placeholder="Type something"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
