@section('title', 'Spa Sub Category - '.$spa_category->title)
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('spa-sub-category.index') }}" class="font-weight-bold">Spa Category</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="list" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($spa_sub_categories as $data)
                                    <tr>
                                        <td>{{ $data->title }}</td>
                                        <td>
                                            @if ($data->status == '1')
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="POST" action="{{ route('spa-sub-category.destroy', [$data->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                ...
                <div class="col-lg-4">
                    <form method="POST" action="{{ route('spa-sub-category.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="spa_category_id" type="hidden" value="{{ $spa_category->id }}">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
