    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="POST" action="{{ route('spa-image.destroy', [$fi->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                ...
                <div class="col-lg-4">
                    <form method="POST" action="{{ route('spa-image.store') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input name="spa_image" type="file" class="custom-file-input">
