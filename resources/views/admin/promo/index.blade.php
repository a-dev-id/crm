...
@section('nav_button')
    <li class="nav-item">
        <a class="nav-link btn btn-success btn-sm text-white font-weight-bold" href="{{ route('promo.create') }}">
                                    ...
                                    @foreach ($promos as $p)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('promo.show', [$p->id]) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-images"></i>
                                                </a>
                                                <a href="{{ route('promo.edit', [$p->id]) }}" class="btn btn-sm btn-warning">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="POST" action="{{ route('promo.destroy', [$p->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
