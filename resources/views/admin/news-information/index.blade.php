@section('title', 'News Information')
@section('news_information_active', 'active')
@section('nav_button')
    <li class="nav-item">
        <a class="nav-link btn btn-success btn-sm text-white font-weight-bold" href="{{ route('news-information.create') }}">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="list" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($news_informations as $p)
                                        <tr>
                                            <td>{{ $p->title }}</td>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('news-information.edit', [$p->id]) }}" class="btn btn-sm btn-warning">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="POST" action="{{ route('news-information.destroy', [$p->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
