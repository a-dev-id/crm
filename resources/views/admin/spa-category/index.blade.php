    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                                    ...
                                    @foreach ($spa_categories as $fc)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('spa-sub-category.show', [$fc->id]) }}" class="btn btn-sm btn-secondary">
                                                    <i class="fas fa-level-down-alt"></i>
                                                </a>
                                                <a href="{{ route('spa-category.show', [$fc->id]) }}" class="btn btn-sm btn-info">
                ...
                <div class="col-lg-4">
                    <form method="POST" action="{{ route('spa-category.store') }}" enctype="multipart/form-data">
                        @csrf
