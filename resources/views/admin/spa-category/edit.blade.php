@section('title', 'Edit Spa Category')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                                    ...
                                    @foreach ($spa_categories as $fc)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('spa-category.edit', [$fc->id]) }}" class="btn btn-sm btn-warning">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="POST" action="{{ route('spa-category.destroy', [$fc->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                ...
                <div class="col-lg-4">
                    <form method="POST" action="{{ route('spa-category.update', [$spa_category->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input name="title" type="text" class="form-control" placeholder="Type something" value="{{ $spa_category->title }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input name="old_icon" type="hidden" value="{{ $spa_category->icon }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1" @if ($spa_category == '1') selected @else @endif>Published</option>
                                        <option value="0" @if ($spa_category == '0') selected @else @endif>Draft</option>
                                    </select>
                                </div>
                            </div>
