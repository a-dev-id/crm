            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('review.index') }}" class="font-weight-bold">Review</a></li>
                        ...
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input name="name" type="text" class="form-control" placeholder="Type something" value="{{ $review->name }}">
                                </div>
                                <div class="form-group">
                                    <label>Star</label>
                                    <input name="star" type="text" class="form-control" placeholder="Type something" value="{{ $review->star }}">
                                </div>
                                <div class="form-group">
                                    <label>Date</label>
                                    <input name="date" type="date" class="form-control" placeholder="Type something" value="{{ $review->date }}">
                                </div>
                                <div class="form-group">
                                    <label>Comment</label>
                                    <textarea name="comment" class="form-control" rows="4" id="comment" placeholder="Type something">{{ $review->comment }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Source</label>
                                    <input name="source" type="text" class="form-control" placeholder="Type something" value="{{ $review->source }}">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                                    <select name="status" class="form-control">
                                        <option value="1" @if ($review->status == '1') selected @else @endif>Published</option>
                                        <option value="0" @if ($review->status == '0') selected @else @endif>Draft</option>
                                    </select>
                                </div>
                            </div>
