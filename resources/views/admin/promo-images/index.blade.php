    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-danger">
                                                                ...
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <promon aria-hidden="true">×</promon>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="POST" action="{{ route('promo-image.destroy', [$fi->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                ...
                <div class="col-lg-4">
                    <form method="POST" action="{{ route('promo-image.store') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input name="promo_image" type="file" class="custom-file-input">
                                            <label class="custom-file-label">Choose file</label>
                                        </div>
                                        <div class="input-group-append">
                                            <promon class="input-group-text">Upload</promon>
                                        </div>
                                    </div>
                                </div>
                            </div>
