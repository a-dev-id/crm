...
<x-app-layout>
    <section class="content">
        <div class="container-fluid">
            <form method="POST" action="{{ route('spa.store') }}" enctype="multipart/form-data" class="row">
                @csrf
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="spa_sub_category_id" class="form-control">
                                    ...
                                    <optgroup label="{{ $fc->title }}">
                                        @foreach ($fc->SpaSubCategories as $ssc)
                                        <option value="{{ $ssc->id }}">{{ $ssc->title }}</option>
                                        @endforeach
                                    </optgroup>
