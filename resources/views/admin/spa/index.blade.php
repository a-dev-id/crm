@section('title', 'Spa List')
@section('spa', 'menu-open')
@section('spa_active', 'active')
@section('spa_list_active', 'active')
@section('nav_button')
    <li class="nav-item">
        <a class="nav-link btn btn-success btn-sm text-white font-weight-bold" href="{{ route('spa.create') }}">
                                    ...
                                    @foreach ($spas as $p)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('spa.show', [$p->id]) }}" class="btn btn-sm btn-info">
                                                    <i class="fas fa-images"></i>
                                                </a>
                                                <a href="{{ route('spa.edit', [$p->id]) }}" class="btn btn-sm btn-warning">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="POST" action="{{ route('spa.destroy', [$p->id]) }}">
                                                                    @csrf
                                                                    @method('DELETE')
