            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="input-group mb-3">
                        <input name="email" value="{{ old('email') }}" type="email" class="form-control" placeholder="Email" required autofocus>
                    ...
                    <div class="input-group mb-3">
                        <input name="password" required autocomplete="current-password" type="password" class="form-control" placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
